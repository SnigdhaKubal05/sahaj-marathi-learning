...
def insert_default_data():
    ...
    if cursor.fetchone()[0] == 0:
        sentences = [
            ...
            ("दिवा लाव कृपया.",                       "gharguti"),
            ("चहा करा कृपया.",                        "gharguti"),
            ("औषध घ्यायची वेळ झाली.",                 "gharguti"),
            ("खिडकी बंद कर कृपया.",                   "gharguti"),
            ("टीव्ही बंद कर.",                        "gharguti"),
            ("मला थकवा आला आहे.",                     "gharguti"),
            ("आंघोळीचे पाणी गरम कर.",                 "gharguti"),
            ("मला चादर आण कृपया.",                    "gharguti"),
            ...
            ("मला श्वास घ्यायला त्रास होतो.",          "hospital"),
            ...
            ("हे महाग आहे.",                          "market"),
            ("थोडे कमी करा किंमत.",                   "market"),
            ("मला तांदूळ हवा आहे.",                   "market"),
            ...
            ("मला पडलो आहे, उठता येत नाही.",          "help"),
